...
const { LINK_AI_APP_KEY, LINK_AI_APP_CODE, APP_ID, APP_SECRET, COS_SECRET_ID, COS_SECRET_KEY } = process.env;
...
export const voice2Text = async (voiceUrl: string) => {
  try {
    ...
    console.log('voice2Text error', error);
    return undefined;
  }
};
